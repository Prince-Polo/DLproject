...
MODE="svg"
CONCEPT="butterfly" # Change this to the desired concept
INPUT_PATH="/root/autodl-tmp/DLproject/code/data/svg/caterpillar" # Change this to the desired SVG file path
SEED=0
COLOR=boolean{True} 
