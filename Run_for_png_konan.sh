...
MODE="png"
CONCEPT="Kudo Shinichi" # Change this to the desired concept
INPUT_PATH="/root/autodl-tmp/DLproject/code/data/png/konan" # Change this to the desired SVG file path
SEED=0
COLOR=boolean{True} 
