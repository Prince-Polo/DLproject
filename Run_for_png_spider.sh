...
MODE="png"
CONCEPT="spiderman" # Change this to the desired concept
INPUT_PATH="/root/autodl-tmp/DLproject/code/data/png/spider" # Change this to the desired SVG file path
SEED=0
COLOR=boolean{True} 
